export const frontendBulletpoints = [
...
export const backendBulletpoints = [
    ...
    "Devloping with Postman to interact with API endpoints"
]
export const web3Bulletpoints = [
